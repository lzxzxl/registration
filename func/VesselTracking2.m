...
for Number_seq=seq_list
    ...
    %点对应3
    params=struct();
    [VesData2D_Match,match]=CRFmatching(VesData3D_Seg,VesData2D,VesData3D_Proj,params);
    ...
    % interior-point
    % VesData3D_Trans=solve_interior_point(VesData3D_Init,VesData3D_Trans,VesData3D_Match,adj_matrix,0.16);
    VesData3D_Proj=Proj(VesData3D_Trans',VesData2D.K);
    toc
    %%%画非刚性结构图
    figure;
    ...
    ax = gca;
    ax.Visible = 'off';
    exportgraphics(ax,['Result1\OURS_left_',num2str(num_file),'.png']);
    % 

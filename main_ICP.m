...
% 
% hold on
% plot(VesData2D.Centerline(root2d_id,1),VesData2D.Centerline(root2d_id,2),'r*');
...
% ax = gca;
% ax.Visible = 'off';
% exportgraphics(ax,'C:\Users\Lzx\Desktop\配准\paper_miccai\experiment_picture\Rigid\RAW_left2.png');
...
ax = gca;
ax.Visible = 'off';
exportgraphics(ax,'C:\Users\Lzx\Desktop\配准\paper_miccai\experiment_picture\Rigid\ICP_left1_nontext.png');
...
ax = gca;
ax.Visible = 'off';
exportgraphics(ax,'C:\Users\Lzx\Desktop\配准\paper_miccai\experiment_picture\NonRigid\Deformable_left1_ori_nontext.png');